...
import com.traclabs.biosim.client.control.AnalyticalController6;
import com.traclabs.biosim.client.util.BioHolderInitializer;
import com.traclabs.biosim.idl.simulation.food.PlantType;
import com.traclabs.biosim.idl.simulation.food.Shelf;


public class ReliabilityFitnessFunction6 extends ReliabilityFitnessFunction {
	private static final long serialVersionUID = -2120248334982483558L;
	public static final int NEEDED_CHROMOSOME_SIZE = 37;
	
	public ReliabilityFitnessFunction6(String configurationFile) {
		super(configurationFile);
	}
	
	public ReliabilityFitnessFunction6() {
		super(AnalyticalController6.DEFAULT_CONFIGURATION_FILE);
	}
	...
	protected void plantShelf(){
    	...
    	double ShelfSizeTotal= shelfSizeOne + shelfSizeTwo + shelfSizeThree + shelfSizeFour + shelfSizeFive + shelfSizeSix + shelfSizeSeven + shelfSizeEight + shelfSizeNine;
    	double volume = height * ShelfSizeTotal;

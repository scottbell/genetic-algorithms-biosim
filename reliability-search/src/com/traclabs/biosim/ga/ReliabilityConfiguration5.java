...
public class ReliabilityConfiguration5 extends ReliabilityConfiguration {
	private static final long serialVersionUID = 4362193844324864379L;

	private static Logger myLogger = Logger
			.getLogger(ReliabilityConfiguration5.class);
	...
	protected Gene[] createGeneArray() {
		return new Gene[ReliabilityFitnessFunction5.NEEDED_CHROMOSOME_SIZE];
	}

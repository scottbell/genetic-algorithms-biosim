...
public class ReliabilityConfiguration6 extends ReliabilityConfiguration {
	private static final long serialVersionUID = -8112680918933006873L;

	private static Logger myLogger = Logger
			.getLogger(ReliabilityConfiguration6.class);
	...
	protected void setupGene() {
		try {
			...
			myGenes[37] = new DoubleGene(this, 0.8, 2.4);  //Crop Growth Chamber height	
	...
	protected Gene[] createGeneArray() {
		return new Gene[ReliabilityFitnessFunction6.NEEDED_CHROMOSOME_SIZE];
	}

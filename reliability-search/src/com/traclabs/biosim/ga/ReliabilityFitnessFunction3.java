...
import com.traclabs.biosim.client.control.AnalyticalController3;
import com.traclabs.biosim.client.util.BioHolderInitializer;
import com.traclabs.biosim.idl.simulation.food.PlantType;
import com.traclabs.biosim.idl.simulation.food.Shelf;


public class ReliabilityFitnessFunction3 extends ReliabilityFitnessFunction {
	private static final long serialVersionUID = 2569223095012920896L;

	public static final int NEEDED_CHROMOSOME_SIZE = 37;
	
	public ReliabilityFitnessFunction3(String configurationFile) {
		super(configurationFile);
	}
	
	public ReliabilityFitnessFunction3() {
		super(AnalyticalController3.DEFAULT_CONFIGURATION_FILE);
	}

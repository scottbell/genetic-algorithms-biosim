...
import com.traclabs.biosim.client.control.AnalyticalController5;
import com.traclabs.biosim.client.util.BioHolderInitializer;
import com.traclabs.biosim.idl.simulation.food.PlantType;
import com.traclabs.biosim.idl.simulation.food.Shelf;

public class ReliabilityFitnessFunction5 extends ReliabilityFitnessFunction {
	private static final long serialVersionUID = 3883381523342918738L;
	
	public static final int NEEDED_CHROMOSOME_SIZE = 38;
	
	public ReliabilityFitnessFunction5(String configurationFile) {
		super(configurationFile);
	}
	
	public ReliabilityFitnessFunction5() {
		super(AnalyticalController5.DEFAULT_CONFIGURATION_FILE);
	}
	...
	protected void plantShelf(){
    	...
    	float height = getFloatValueFromAllele(37);
    	float ShelfSizeTotal= shelfSizeOne + shelfSizeTwo + shelfSizeThree + shelfSizeFour + shelfSizeFive + shelfSizeSix + shelfSizeSeven + shelfSizeEight + shelfSizeNine;
    	float volume = height * ShelfSizeTotal;
